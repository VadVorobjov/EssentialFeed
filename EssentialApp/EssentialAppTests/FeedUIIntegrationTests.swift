...
class FeedUIIntegrationTests: XCTestCase {
    ...
    func test_loadFeedActions_requestFeedFromLoader() {
        ...
        sut.simulateUserInitiatedReload()
        XCTAssertEqual(loader.loadFeedCallCount, 3, "Expected yet another request once user initiates anoter reload")
    }
...
//    }
    ...
    func test_feedImageView_configuresViewCorrectlyWhenTransitioningFromNearVisibleToVisibleWhileStillPreloadingImage() {
        ...
        XCTAssertEqual(view0?.renderedImage, imageData, "Expected rendered image data after image preloads successfully")
        XCTAssertEqual(view0?.isShowingRetryAction, false, "Expected no retry action after image preloads successfully")
        XCTAssertEqual(view0?.isShowingImageLoadingIndicator, false, "Expected no loading indicator after imagae preloads successfully")
    }
