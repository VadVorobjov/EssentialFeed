...
class RemoteFeedImageDataLoaderTests: XCTestCase {
    ...
    func test_loadImageDataFromURL_deliversInvalidDataErrorOn200ResponseWithEmptyData() {
        let (sut, client) = makeSUT()
    ...
    func test_loadImageDataFromURL_doesNotDeliverResultAfterCancellingTask() {
        ...
        XCTAssertTrue(received.isEmpty, "Expected no received results after cancellig task")
    }
